/**
 * WORKING Discord Bot Function with Fixed Signature Verification
 * Based on exact data captured from Discord verification attempt
 */

const crypto = require('crypto');

exports.handler = async (event, context) => {
  console.log('=== DISCORD BOT WORKING VERSION ===');
  ...
  try {
    ...
    // Verify Discord signature using the official Discord method
